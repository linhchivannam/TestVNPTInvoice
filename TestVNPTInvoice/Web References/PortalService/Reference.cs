...
namespace TestVNPTInvoice.PortalService {
    ...
    public partial class PortalService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetInvViewByDatePagingOperationCompleted;
        ...
        public PortalService() {
            this.Url = global::TestVNPTInvoice.Properties.Settings.Default.TestVNPTInvoice_PortalService_PortalService;
        ...
        /// <remarks/>
        public event GetInvViewByDatePagingCompletedEventHandler GetInvViewByDatePagingCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetInvViewByDatePaging", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string GetInvViewByDatePaging(string userName, string userPass, string pattern, string serial, string fromDate, string toDate, int pageIndex, int pageSize) {
            object[] results = this.Invoke("GetInvViewByDatePaging", new object[] {
                        userName,
                        userPass,
                        pattern,
                        serial,
        ...
        /// <remarks/>
        public void GetInvViewByDatePagingAsync(string userName, string userPass, string pattern, string serial, string fromDate, string toDate, int pageIndex, int pageSize) {
            this.GetInvViewByDatePagingAsync(userName, userPass, pattern, serial, fromDate, toDate, pageIndex, pageSize, null);
        }
        
        /// <remarks/>
        public void GetInvViewByDatePagingAsync(string userName, string userPass, string pattern, string serial, string fromDate, string toDate, int pageIndex, int pageSize, object userState) {
            if ((this.GetInvViewByDatePagingOperationCompleted == null)) {
                this.GetInvViewByDatePagingOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetInvViewByDatePagingOperationCompleted);
            }
            this.InvokeAsync("GetInvViewByDatePaging", new object[] {
                        userName,
                        userPass,
                        pattern,
                        serial,
                        ...
                        toDate,
                        pageIndex,
                        pageSize}, this.GetInvViewByDatePagingOperationCompleted, userState);
        }
        
        private void OnGetInvViewByDatePagingOperationCompleted(object arg) {
            if ((this.GetInvViewByDatePagingCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetInvViewByDatePagingCompleted(this, new GetInvViewByDatePagingCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9037.0")]
    public delegate void GetInvViewByDatePagingCompletedEventHandler(object sender, GetInvViewByDatePagingCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9037.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetInvViewByDatePagingCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetInvViewByDatePagingCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
